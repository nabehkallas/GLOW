...
class NewOrderPlaced extends Notification
{
    ...
    public function toWebPush(object $notifiable): WebPushMessage
    {
        ...
        return (new WebPushMessage)
            ->title(trans($isB2b ? 'notifications.new_order.title_b2b' : 'notifications.new_order.title_b2c', [], $locale))
            ->body(trans('notifications.new_order.body', ['id' => $this->order->id, 'name' => $name], $locale))
            ->data([
