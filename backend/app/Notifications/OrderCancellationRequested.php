...
class OrderCancellationRequested extends Notification
{
    ...
    public function toWebPush(object $notifiable): WebPushMessage
    {
        ...
        return (new WebPushMessage)
            ->title(trans('notifications.order_cancellation_requested.title', [], $locale))
            ->body(trans('notifications.order_cancellation_requested.body', ['id' => $this->order->id, 'name' => $name], $locale))
            ->data([
